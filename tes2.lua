...
local rev = "Checkpoint touch v0.7.2   "
--============ GUI ==================--
...
local cp1
while loopRunning do
	cp1 = workspace:FindFirstChild("CheckPoint"):FindFirstChild("CheckPoint1")
	if cp1 and cp:IsA("BasePart") then
		hrp = getHRP()
		fireTouch(hrp, cp1)
		...
		logBox.Text = "Rendering CP1"
		freezeCharacter()
		renderAtPosition(pos1)
		renderAtPosition(basePos)
		unfreezeCharacter()
		task.wait(1)
	end
