...
local function runLoop()
	...
	while loopRunning do
		...
		local function scanCheckpoint(cpName, pos)
			while loopRunning do
				local cpFolder = workspace:FindFirstChild("CheckPoint")
				local cp = cpFolder and cpFolder:FindFirstChild(cpName)
		...
		-- Pemanggilan satu-satu
		scanCheckpoint("CheckPoint1", pos1)
		scanCheckpoint("CheckPoint2", pos2)
		scanCheckpoint("CheckPoint3", pos3)
		scanCheckpoint("CheckPoint4", pos4)
		scanCheckpoint("CheckPoint5", pos5)
		scanCheckpoint("CheckPoint6", pos6)
		scanCheckpoint("CheckPoint7", pos7)
